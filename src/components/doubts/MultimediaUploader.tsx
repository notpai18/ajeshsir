      ...
      >
        ...
        {isUploading ? (
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="w-12 h-12 rounded-full bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] flex items-center justify-center mb-2">
          ...
          <AnimatePresence>
            {files.map((file) => (
              <motion.div
                ...
                className="relative group rounded-xl border border-gray-200 overflow-hidden bg-white dark:bg-[#22201F] dark:bg-[#22201F] shadow-sm flex items-center p-2 gap-3"
              >
