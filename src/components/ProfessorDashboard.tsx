...
const ROW_BTN =
  'inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5]';
...
const EXAM_STYLES: Record<string, { bg: string; text: string; dot: string }> = {
  'jee-main': { bg: 'bg-[#F4E7E5] dark:bg-[#380A14]', text: 'text-[#4A0E1B] dark:text-[#F4E7E5]', dot: 'bg-[#4A0E1B]' },
...
function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[#E0D5C2] bg-[#FBF7F0] dark:bg-[#2A2725] px-6 py-14 text-center">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]">{icon}</div>
  ...
  return (
    <div className="block">
      ...
      <div className="relative">
        <input
          type="url"
          className={`w-full rounded-xl border bg-[#FBF7F0] dark:bg-[#2A2725] px-3.5 py-2.5 pr-10 text-sm text-[#22201F] dark:text-[#F6F2EA] placeholder:text-[#B3A996] dark:text-[#7A6F62] outline-none transition ${
            showError
              ...
              : 'border-[#E3D8C5] dark:border-[#4A433E] focus:border-[#4A0E1B]/50 focus:bg-white dark:bg-[#22201F] focus:ring-4 focus:ring-[#4A0E1B]/10'
          }`}
          required
          value={value}
          onChange={(e) => {
        ...
        <div className="grid gap-7 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-3">
            <div className="lg:sticky lg:top-24">
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex w-full items-center gap-3 rounded-[12px] px-3.5 py-2.5 text-sm font-semibold transition-all duration-200 ${
                          active ? 'bg-[#4A0E1B]/8 text-[#4A0E1B] dark:text-[#F4E7E5]' : 'text-[#22201F] dark:text-[#F6F2EA]/80 hover:bg-[#F7F3EC] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA]'
                        }`}
                      >
              ...
              <div className="mt-3 flex items-center gap-2 rounded-xl border border-[#EAE1D2] dark:border-[#383330] bg-[#FBF7F0] dark:bg-[#2A2725] px-3.5 py-3 text-[11px] text-[#8A7E6F] dark:text-[#A89F91]">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <PremiumCard padding="large" accentLine>
                    <div className="mb-5 flex items-center justify-between">
                      ...
                      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">
                        <TrendingUp size={17} />
                      </span>
                    </div>
                    {topNotes.length === 0 ? (
                  ...
                  <PremiumCard padding="large" accentLine>
                    ...
                    {pendingDoubtsCount === 0 ? (
                      <div className="flex flex-col items-center py-6 text-center">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]">
                          <Check size={20} />
                        </span>
                        ...
                        {doubts
                           ...
                           .map((d) => (
                             <button
                               ...
                               className="flex w-full items-start gap-3 rounded-xl border border-[#EFE7D8] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2725] p-3 text-left transition-colors hover:border-[#E3D1CD] hover:bg-[#F8EEEC]"
                             >
                    ...
                    {recentUploads.length === 0 ? (
                      ...
                      <div className="space-y-1">
                        {recentUploads.map((item, i) => (
                          <div key={i} className="flex items-center gap-3 border-b border-[#F2ECDF] dark:border-[#2A2725] py-2.5 last:border-0">
                            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F4E7E5] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">{typeIcon[item.type]}</span>
                            <div className="min-w-0 flex-1">
              ...
              >
                {notesFiltered.length === 0 ? (
                  ...
                  <Table head={['Exam & subject', 'Title & chapter', 'Downloads', '']}>
                    {notesFiltered.map((n) => (
                      <tr key={n.id} className="transition-colors hover:bg-[#FBF7F0] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]">
                ...
                {videosFiltered.length === 0 ? (
                  ...
                  <Table head={['Exam & subject', 'Lecture & chapter', 'Duration', '']}>
                    {videosFiltered.map((v) => (
                      <tr key={v.id} className="transition-colors hover:bg-[#FBF7F0] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]">
                        <td className="px-5 py-3.5">
              ...
              >
                {pyqsFiltered.length === 0 ? (
                  ...
                  <Table head={['Exam & subject', 'Chapter & year', 'Difficulty', '']}>
                    {pyqsFiltered.map((p) => (
                      <tr key={p.id} className="transition-colors hover:bg-[#FBF7F0] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]">
                        <td className="px-5 py-3.5">
                ...
                {sheetsFiltered.length === 0 ? (
                  ...
                  <Table head={['Exam & subject', 'Title', 'Chapter', '']}>
                    {sheetsFiltered.map((s) => (
                      <tr key={s.id} className="transition-colors hover:bg-[#FBF7F0] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]">
                        <td className="px-5 py-3.5">
            ...
            {activeTab === 'doubts' && (
              <div className="space-y-5">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="inline-flex rounded-xl border border-[#EAE1D2] dark:border-[#383330] bg-white dark:bg-[#22201F] p-1">
                      ...
                      <PremiumCard key={doubt.id} padding="medium" className={!doubt.isAnswered ? 'ring-1 ring-[#4A0E1B]/12' : ''}>
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-start gap-3">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">
                              <User size={16} />
                            </span>
                            <div>
                          ...
                          <div className="flex flex-col items-end gap-1.5">
                            ...
                            {!doubt.isAnswered ? (
                              ...
                              <span className="inline-flex items-center gap-1 rounded-full bg-[#F7EFD9] dark:bg-[#362A0D] px-2 py-0.5 text-[10px] font-bold text-[#8A6A16] dark:text-[#E8CD82]">
                        ...
                        <p className="mt-1.5 rounded-xl border border-[#EFE7D8] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2725] p-3.5 text-sm leading-relaxed text-[#3A342E]">{doubt.question}</p>
                          ...
                          <div className="mt-2">
                            {doubt.attachmentDataUrl ? (
                              doubt.attachmentDataUrl.startsWith('data:image/') ? (
                                ...
                                <div className="rounded-xl border border-[#EFE7D8] dark:border-[#332E2C] overflow-hidden">
                                  <img
                                    src={doubt.attachmentDataUrl}
                                    alt={doubt.attachmentName}
                                    className="w-full max-h-48 object-contain bg-[#FBF7F0] dark:bg-[#2A2725] cursor-pointer"
                                    onClick={() => {
                                  ...
                                  />
                                  <div className="flex items-center justify-between px-3 py-1.5 bg-[#FBF7F0] dark:bg-[#2A2725] border-t border-[#EFE7D8] dark:border-[#332E2C]">
                                ...
                                <div className="flex items-center gap-2.5 rounded-xl border border-[#EFE7D8] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2725] px-3.5 py-2.5">
                  ...
                  <div className="space-y-4">
                    {annSorted.map((a) => (
                      <PremiumCard key={a.id} padding="medium" className={a.pinned ? 'ring-1 ring-[#4A0E1B]/15' : ''}>
                        ...
                        <p className="mt-1.5 text-sm leading-relaxed text-[#5A534B] dark:text-[#A89F91]">{a.body}</p>
                        <div className="mt-4 flex items-center gap-1 border-t border-[#F2ECDF] dark:border-[#2A2725] pt-3">
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                ...
                <PremiumCard padding="large" accentLine>
                  ...
                  <p className="mt-1 max-w-xl text-sm leading-relaxed text-[#5A534B] dark:text-[#A89F91]">
      ...
      {(activeModal === 'add-announcement' || activeModal === 'edit-announcement') && (
        <Modal title={activeModal === 'add-announcement' ? 'New announcement' : 'Edit announcement'} subtitle="Broadcast a notice to everyone in the portal" onClose={closeModal}>
          <form onSubmit={handleAnnouncementSubmit} className="space-y-4">
            ...
            <label className="flex items-center gap-2.5 rounded-xl border border-[#EFE7D8] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2725] px-3.5 py-3">
      ...
      {confirm && (
        <Modal title={confirm.title} onClose={() => setConfirm(null)}>
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm leading-relaxed text-[#5A534B] dark:text-[#A89F91]">{confirm.message}</p>
          </div>
...
function RowActions({ onView, onEdit, onDelete }: { onView?: () => void; onEdit: () => void; onDelete: () => void }) {
  return (
    <div className="flex justify-end gap-1">
      {onView && (
        <button onClick={onView} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:hover:bg-[#380A14] dark:bg-[#380A14] hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5]" aria-label="View PDF">
          <Eye size={15} />
        </button>
      )}
      <button onClick={onEdit} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:hover:bg-[#380A14] dark:bg-[#380A14] hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5]" aria-label="Edit">
        <Pencil size={15} />
      </button>
