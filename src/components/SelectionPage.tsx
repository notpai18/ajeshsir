...
export default function SelectionPage({ onSelectRole }: SelectionPageProps) {
  return (
    <section className="flex min-h-[70vh] items-center justify-center bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] py-16">
      <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-2 text-3xl font-serif font-extrabold tracking-tight text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] sm:text-4xl">
            Who are you?
          </h2>
        ...
        <div className="mt-10 text-center">
          <p className="font-sans text-[9px] uppercase tracking-wider text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 font-bold">
