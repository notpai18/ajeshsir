    ...
    <div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div className={`${CARD} flex flex-col p-6`}>
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] text-[#4A0E1B]">
        ...
        <div className={`${CARD} flex flex-col p-6`}>
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] text-[#8A6A16]">
            <BookOpen size={20} />
          </span>
