              ...
              return (
                <div key={faq.id} className="overflow-hidden rounded-xl border border-[#EAE1D2] dark:border-[#4A433E] bg-white dark:bg-[#22201F]">
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] transition-colors hover:bg-[#FBF7F0] dark:hover:bg-[#2A2726]"
                  >
