...
export default function Navbar({
  ...
  const badgeBg = 'bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]';
  ...
  return (
    <nav className="sticky top-5 z-50 mx-auto mt-5 w-[90%] max-w-7xl rounded-full border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/80 backdrop-blur-[20px] shadow-soft-md transition-all duration-300">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col whitespace-nowrap">
              <span className="text-xl font-['Outfit'] font-bold tracking-tight text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
                Prof. Ajesh Joe
              </span>
          ...
          <div className="hidden items-center space-x-4 lg:flex xl:space-x-8">
                  ...
                  <button
                    ...
                    className={`relative py-2 text-base font-['Outfit'] transition-colors duration-200 hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] ${
                      isActive 
                        ...
                        : 'text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 font-medium'
                    }`}
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={toggleTheme}
                className={`flex items-center gap-2 rounded-full border border-[#D9C2A2]/40 ${badgeBg} px-3 py-1.5 text-xs font-medium text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-all ${badgeHoverBg}`}
                id="theme-toggle-btn"
              >
              ...
              {userRole ? (
                <div className="flex items-center space-x-2">
                  <span className={`flex items-center space-x-1 border border-[#D9C2A2]/40 ${badgeBg} px-2.5 py-1 text-xs font-medium text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/70 rounded-lg transition-colors duration-300`}>
                  ...
                  <button
                    ...
                    className="text-xs font-medium text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] transition-colors underline decoration-transparent hover:decoration-[#4A0E1B] underline-offset-4"
                    id="switch-role-btn"
                  >
                    Switch
                  </button>
          ...
          <div className="flex items-center space-x-3 lg:hidden">
            <button
              ...
              className="rounded-xl p-2 text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]"
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="absolute left-0 right-0 top-full mt-2 rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-4 pt-2 pb-4 shadow-soft-lg transition-colors duration-300 lg:hidden">
              ...
              return (
                <button
                  ...
                  className={`block w-full rounded-xl px-4 py-2.5 text-left text-sm font-medium transition-colors ${
                    isActive 
                      ? `${mobileActiveBg}` 
                      : 'text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80 hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]'
                  }`}
          ...
          <div>
            {userRole ? (
              <div className="flex items-center justify-between px-4 py-2 bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] rounded-xl border border-[#D9C2A2]/30">
                <span className="font-sans text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/70">
          ...
          <div className="border-t border-[#D9C2A2]/30 pt-4 mt-4">
            <button
              onClick={toggleTheme}
              className="flex w-full items-center justify-between rounded-xl px-4 py-3 text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]"
            >
