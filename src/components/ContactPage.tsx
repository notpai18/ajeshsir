    ...
    <section className="bg-[#F7F3EC] dark:bg-[#1A1817] py-16 md:py-20 text-[#22201F] dark:text-[#F6F2EA]">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-[#22201F] dark:text-[#F6F2EA]/60">
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-12">
          ...
          <div className="space-y-6 md:col-span-5">
            ...
            <PremiumCard padding="large" accentLine>
              <div className="space-y-5">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <h4 className="font-sans text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F] dark:text-[#F6F2EA]/60">Department</h4>
                    <p className="text-xs font-bold text-[#22201F] dark:text-[#F6F2EA] mt-1">
                      Department of Chemistry
                    </p>
                    <p className="text-[10px] text-[#22201F] dark:text-[#F6F2EA]/60 mt-0.5">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <h4 className="font-sans text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F] dark:text-[#F6F2EA]/60">Office Location</h4>
                    <p className="text-xs font-bold text-[#22201F] dark:text-[#F6F2EA] mt-1">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <h4 className="font-sans text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F] dark:text-[#F6F2EA]/60">Academic Email</h4>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    <h4 className="font-sans text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F] dark:text-[#F6F2EA]/60">Office Hours</h4>
                    <p className="text-xs font-bold text-[#22201F] dark:text-[#F6F2EA] mt-1">
                      Mondays & Wednesdays: 2:00 PM – 4:00 PM
                    </p>
                    <p className="text-xs text-[#22201F] dark:text-[#F6F2EA]/60 mt-0.5">
            ...
            <div className="border-l-4 border-[#4A0E1B] bg-white dark:bg-[#22201F] p-4 rounded-r-xl border-y border-r border-[#D9C2A2]/30 shadow-soft-sm">
              <p className="text-[11px] leading-relaxed text-[#22201F] dark:text-[#F6F2EA]/60">
          ...
          <div className="md:col-span-7">
            <PremiumCard padding="large" accentLine>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="name" className="block text-[9px] font-bold text-[#22201F] dark:text-[#F6F2EA]/80 uppercase tracking-[0.2em]">
                    Full Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="mt-2 block w-full border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] px-3.5 py-3 text-sm text-[#22201F] dark:text-[#F6F2EA] rounded-input outline-none transition focus:border-[#4A0E1B]/50 focus:ring-4 focus:ring-[#C9A13B]/10 placeholder:text-[#22201F] dark:text-[#F6F2EA]/30"
                    placeholder="e.g. Rahul Gupta"
                  />
                </div>

                <div>
                  <label htmlFor="email" className="block text-[9px] font-bold text-[#22201F] dark:text-[#F6F2EA]/80 uppercase tracking-[0.2em]">
                ...
                <div>
                  <label htmlFor="subject" className="block text-[9px] font-bold text-[#22201F] dark:text-[#F6F2EA]/80 uppercase tracking-[0.2em]">
                    Subject / Topic
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-[9px] font-bold text-[#22201F] dark:text-[#F6F2EA]/80 uppercase tracking-[0.2em]">
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    className="mt-2 block w-full border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] px-3.5 py-3 text-sm text-[#22201F] dark:text-[#F6F2EA] rounded-input outline-none transition focus:border-[#4A0E1B]/50 focus:ring-4 focus:ring-[#C9A13B]/10 placeholder:text-[#22201F] dark:text-[#F6F2EA]/30 resize-none"
