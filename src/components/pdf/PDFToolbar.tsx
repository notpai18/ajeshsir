...
export function PDFToolbar({ onClose }: PDFToolbarProps) {
  ...
  const ICON_BTN = 'flex h-8 w-8 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#4A0E1B] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A0E1B]/20';
      ...
      <div className="flex items-center gap-1">
        ...
        <form onSubmit={handlePageSubmit} className="flex items-center gap-1">
          <input
            ...
            className="w-10 rounded-lg border border-[#D9C2A2]/40 bg-[#F7F3EC] dark:bg-[#1A1817]/50 px-1.5 py-1 text-center text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] outline-none transition focus:border-[#4A0E1B]/50 focus:ring-2 focus:ring-[#C9A13B]/20"
      ...
      <div className="flex items-center gap-0.5">
        ...
        <div className="relative" ref={zoomMenuRef}>
          <button
            ...
            className="flex h-8 items-center gap-1 rounded-lg border border-[#D9C2A2]/40 bg-[#F7F3EC] dark:bg-[#1A1817]/50 px-2 text-[10px] font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:border-[#4A0E1B]/30"
            ...
            <div className="absolute right-0 top-full z-50 mt-1 w-36 overflow-hidden rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-1 shadow-soft-lg">
              {ZOOM_PRESETS.map(z => (
                <button
                  ...
                  className={`flex w-full items-center rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] ${Math.abs(zoom - z) < 0.01 && zoomMode === 'custom' ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA]/80'}`}
                >
                  {Math.round(z * 100)}%
                </button>
              ))}
              ...
              <button
                ...
                className={`flex w-full items-center rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] ${zoomMode === 'fitWidth' ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA]/80'}`}
              >
                Fit Width
              </button>
              <button
                onClick={() => handleZoomChange('fitPage')}
                className={`flex w-full items-center rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] ${zoomMode === 'fitPage' ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA]/80'}`}
              >
                Fit Page
              </button>
            </div>
  ...
  return (
    <div className="flex items-center gap-2 rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-2 shadow-soft-lg">
      ...
      <input
        ...
        className="w-52 bg-transparent text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#22201F] dark:text-[#F6F2EA]/30 outline-none"
      ...
      <button
        onClick={onClose}
        className="flex h-6 w-6 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA]/60 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#4A0E1B]"
