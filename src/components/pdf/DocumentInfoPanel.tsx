    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex h-6 w-6 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA]/60 transition-colors hover:bg-[#D9C2A2]/20 hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]"
