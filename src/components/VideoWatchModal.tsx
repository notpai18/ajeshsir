    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-0 sm:p-4 dash-root">
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between gap-4 border-b border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] px-4 py-3 sm:px-5">
          {/* Breadcrumb */}
          <nav className="flex min-w-0 items-center gap-1.5 text-xs text-[#22201F] dark:text-[#F6F2EA]/60">
            <button
              onClick={onClose}
              className="shrink-0 font-semibold text-[#22201F] dark:text-[#F6F2EA] hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] transition-colors"
            >
              Library
            </button>
            <ChevronRight size={12} className="shrink-0 text-[#D9C2A2]" />
            <span className="shrink-0 font-semibold text-[#22201F] dark:text-[#F6F2EA]">{examLabel}</span>
            <ChevronRight size={12} className="shrink-0 text-[#D9C2A2]" />
            <span className="shrink-0 font-semibold text-[#22201F] dark:text-[#F6F2EA]">Video Lectures</span>
            <ChevronRight size={12} className="shrink-0 text-[#D9C2A2]" />
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={`line-clamp-2 text-xs font-semibold leading-snug ${
                          isActive ? 'text-[#4A0E1B] dark:text-[#F4E7E5]' : 'text-[#22201F] dark:text-[#F6F2EA] group-hover:text-[#4A0E1B] dark:group-hover:text-[#F4E7E5] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5]'
                        } transition-colors`}
                      >
                        {item.title}
                      </p>
