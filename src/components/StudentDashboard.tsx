...
function StudentDashboardContent({
  ...
  const categoryCards = [
    ...
    { id: 'doubts' as const, title: 'Doubts & FAQ', desc: 'Ask the professor a direct question or browse common answers.', icon: <span className="text-[36px] leading-none" role="img" aria-label="Doubts">❓</span>, count: null, unit: '' },
