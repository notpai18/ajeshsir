    ...
    <div className="relative w-full h-[420px] rounded-[40px] bg-gradient-to-br from-[#4A0E1B] to-[#7C2532] shadow-[0_24px_50px_-12px_rgba(74,14,27,0.5)] overflow-hidden flex flex-col md:flex-row items-center animate-[fadeInUp_0.8s_ease-out_forwards]">
      ...
      <div className="relative z-10 hidden md:flex w-2/5 h-full items-center justify-center">
        <div className="relative w-80 h-80">
          ...
          {/* Electrons */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-4 h-4 bg-white rounded-full shadow-[0_0_15px_#FFF] animate-[spin_4s_linear_infinite]" style={{ transformOrigin: '0 160px' }}></div>
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow-[0_0_15px_#FFF] animate-[spin_6s_linear_infinite_reverse]" style={{ transformOrigin: '-160px 0' }}></div>
