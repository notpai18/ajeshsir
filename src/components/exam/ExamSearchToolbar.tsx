  ...
  return (
    <div className="flex flex-col items-center gap-8 my-16 animate-[fadeInUp_0.8s_ease-out_forwards]">
      ...
      >
        ...
        <div className="relative flex items-center bg-white dark:bg-[#22201F] dark:bg-[#22201F]/70 backdrop-blur-2xl border border-white rounded-full p-2 shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
      ...
      <div className="flex flex-wrap justify-center p-1.5 bg-white dark:bg-[#22201F] dark:bg-[#22201F]/50 backdrop-blur-xl border border-white rounded-full shadow-sm relative">
