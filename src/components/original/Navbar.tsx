...
export default function Navbar({
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b-2 border-gray-800 bg-[#1c1c1e] transition-colors duration-300">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="border-b border-gray-100 bg-white dark:bg-[#22201F] dark:bg-[#22201F] px-4 pt-2 pb-4 transition-colors duration-300 dark:border-slate-800 dark:bg-slate-900 lg:hidden">
