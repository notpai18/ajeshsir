      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 sm:py-14">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-5 flex flex-wrap justify-center gap-2 md:justify-start">
                {[
                  ...
                  <span
                    key={i}
                    className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white dark:bg-[#22201F]/10 px-3 py-1.5 text-[11px] font-semibold text-white/90"
                  >
        ...
        <section className="mt-12">
          ...
          <div className={`${CARD} mt-4 p-6 sm:p-8`}>
            <div className="space-y-4 text-sm leading-relaxed text-[#5A534B] dark:text-[#A89F91]">
              <p>
        ...
        <section className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <ul className="mt-5 space-y-3.5">
              {INTERESTS.map((it, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F4E7E5] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">
                    {it.icon}
                  </span>
          ...
          <div className={`${CARD} p-6`}>
            ...
            <ul className="mt-6 space-y-6 border-l border-[#EAE1D2] dark:border-[#383330] pl-5">
          ...
          <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex shrink-0 flex-wrap gap-2.5">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-white/20 px-4 py-2.5 text-xs font-bold tracking-wide text-white transition-colors hover:bg-white dark:bg-[#22201F]/10"
              >
                Contact office
              </button>
            </div>
